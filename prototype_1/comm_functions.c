...
enum				//Stany automatu
{
	eIdle=0,		//stan oczekiwania na bajt pocz¹tku ramki A5
	eWaitSOF,		//oczewkiwanie na drugi bajt poczatku ramki 5A
	eAdress,		//sprawdzanie adresu
	eCmd,			//odczytywanie komendy
	ePayloadLen,	//odczyt d³ugoœci obszaru odebranych danych
	ePayload,		//odczytywanie danych
	eCRC,			//sprawdzanie sumy kontrolenej
...
// 			uart_puts("/n");
			...
			switch(eProtocolState)
			{
				...
				//oczekiwanie na symbol pocz¹tku ramki
				case eWaitSOF:
				if(u8Byte==0xA5)
				{
				...
				//sprawdzanie adresu przychodz¹cej ramki
				case eAdress:
